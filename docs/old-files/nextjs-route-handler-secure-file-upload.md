"---\ntitle: Next.js Route Handler Secure File Upload\ntags: [nextjs, api-routes, security, file-upload, authorization]\n---\n\n# PROBLEM\nDatei-Uploads in Next.js API-Routen benötigen strikte Sicherheitsüberprüfungen: Authentifizierung, Autorisierung, Dateityp-Sanitierung, Größenbeschränkung und korrekte Dateisystem-Operationen, um Sicherheitslücken zu vermeiden.

# LÖSUNG\n1. Mehrstufige Validierung implementieren (Auth → Authz → Type → Size → Processing)\n2. Session-basierte Authentifizierung verwenden\n3. Eindeutige Dateinamen mit Zeitstempel und ID generieren\n4. Alte Datei vor hochladen einer neuen löschen\n5. Dateisystem-Operationen asynchron mit try/catch behandeln\n6. Upload-Verzeichnisse rekursiv erstellen\n\n# CODE / COMMANDS
```typescript
